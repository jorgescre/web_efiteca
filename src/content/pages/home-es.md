...
whoIsItFor:
  ...
  items:
    - title: Personas que quieren comprar vivienda
...
steps:
  ...
  items:
    - number: 1
      ...
      description: Analizamos tu situación actual y objetivo hipotecario para entender si existe una ruta viable.
    - number: 2
      title: Estudio de viabilidad
      description: Evaluamos tu perfil financiero y laboral para determinar qué bancos podrían aprobar tu solicitud.
    - number: 3
